...
public class CalculatorModel {
    ...
    */
    public void inputOperator(Operator op){
        ...
        /*　エラー時マイナスのみ復帰可能 */
        if(state == InputState.ERROR && op == Operator.SUBTRACT){
            clearAll();
            currentInput.append('-');
            state = InputState.INPUT_NUMBER;
            return;
    ...
    */
    public BigDecimal apply(Operator op,BigDecimal left,BigDecimal right){
        switch (op) {
            ...
            case DIVIDE:
                try{
                    BigDecimal result = left.divide(right,maxDigits+1,RoundingMode.DOWN);
    ...
    */
    public String getDisplayText(){
        ...
        return currentInput.toString();//String型へ型変換
    }
}